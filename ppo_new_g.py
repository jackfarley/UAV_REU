...
def parse_args():
    ...
    parser.add_argument("--ent_coef", type=float, default=.03,
    ...
    parser.add_argument("--total_episodes", type=int, default=2500,
    ...
    parser.add_argument("--g", type=list, default=[(3,3), (5,5), (7,7), (10,10), (15,5), (5,15)],
                    help="list of gbs locations")
    parser.add_argument("--L_s", type=list, default=[(1, 1), (1,1)],
                        help="list of drone starting locations")
    parser.add_argument("--L_f", type=list, default=[(20,1), (1,20)],
                        help="list of drone end locations")
    parser.add_argument("--o_max", type=int, default=3,
