...
import uav_environment_outage_single
...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default="render_single_outage",
    ...
    parser.add_argument("--g", type=list, default=[(1,1), (5,5),(10,10),(15,5), (20,1)],
    ...
    parser.add_argument("--V", type=int, default=1,
                        help="max veloctiy")
    parser.add_argument("--R_G", type=int, default=3.5,
...
if __name__ == "__main__":
    ...
    env = uav_environment_outage_single.uav_collab( args.g, args.L_s, args.L_f, args.o_max, args.V, args.R_G, args.R_U, args.grid_size, args.total_timesteps)
