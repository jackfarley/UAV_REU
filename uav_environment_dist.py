...
class uav_collab(ParallelEnv):
    ...
    def step(self, actions):
        ...
        rewards = {}
        for ind in range(len(self.agents)):
             rewards[self.agents[ind]] = -1 + 10*d_dis[ind]  # pscp -r C:\Users\JackF\Documents\REU\uav_environment\env\ farleyj3@tesla.cs.vcu.edu:/home/farleyj3/rl -.1*(self.dist(self.U_t[ind], self.L_f[ind]))  (-3 * self.c_U[ind]) #self.dist(self.U_t[ind], self.L_s[ind]) #(0 * self.c_U[ind])   
        self.ts += 1
        print(self.U_t)
